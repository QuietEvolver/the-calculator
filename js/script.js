const inputtedName = prompt("Please enter your name:")
let greeting = alert("Hi " + inputtedName + ", have a great day!");

const number1 = prompt(parseInt("First number:"));
...
function multiplication(number1, number2) { return resutl = number1 * number2; };
